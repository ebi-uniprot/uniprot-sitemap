...
module.exports = ({ namespace, query = "*" } = {}) => {
  // Note: "created" search field maps to the "updated" field in the payload 🤷🏼‍♂️
  const baseURL = `https://rest.uniprot.org/${namespace}/search?format=json&query=${query}&fields=id,created`;
